...
VS_CMD_DRAW_SEMI_TRANS_LINE equ $42000000   ; Draws A Semi-Transparent Line to the Display Area 
VS_CMD_SHADE_LINE equ $50000000             ; Draws A Gouraud-Shaded Line to the Display Area 
VS_CMD_SHADE_SEMI_TRANS_LINE equ $52000000  ; Draws A Semi-Transparent Gouraud-Shaded Line to the Display Area
...
DrawLines:
	...
	sw t1, 16(sp) 
	jal VS_DrawSemiTransMonochromeLine    ; VS_DrawSemiTransMonochromeLine(x1,y1,x2,y2,color);
	nop
	jal VS_DrawSync                       ; VS_DrawSync();
	nop
	li a0, 100							  ; x1 = 100;
