...
UploadTextureToVram:
	...
	la t1, TextureNoMask                  ; image = Texture;
	sw t1, 16(sp)
	jal VS_TransferImageDataToVram        ; VS_TransferImageDataToVram(vram_x,vram_y,image_w,image_h,image);
	nop
	li a0, VS_DMA_VRAM_X                  ; vram_x = VS_DMA_VRAM_X;
	li a1, VS_DMA_VRAM_Y                  ; vram_y = VS_DMA_VRAM_Y;
	li a2, VS_TEXTURE_W                   ; image_w = VS_TEXTURE_W;
	li a3, VS_TEXTURE_H                   ; image_h = VS_TEXTURE_H;
	la t1, TextureMask                    ; image = Texture;
	sw t1, 16(sp)
...
DisplayTexture:
	...
	li a1, 128                            ; y = 128;
	move a2, v0                        
	jal VS_TextureImage                   ; VS_TextureImage(x,y,texpage);
	nop
	li a0, 2                              ; mode = 2;
	li a1, 1                              ; alpha = 1;
