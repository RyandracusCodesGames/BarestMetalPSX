...
VS_CMD_FILL_QUAD equ $28000000              ; Draws A Monochrome Quad to the Display Area
VS_CMD_FILL_SEMI_TRANS_QUAD equ $2A000000   ; Draws A Semi-Transparent Quad to the Display Area 
VS_CMD_SHADE_QUAD equ $38000000             ; Draws A Gouraud-Shaded Quad to the Display Area 
VS_CMD_SHADE_SEMI_TRANS_QUAD equ $3A000000  ; Draws A Semi-Transparent Gouraud-Shaded Quad to the Display Area
...
DrawQuads:
	...
	li t1, 56                             ; y4 = 56;
	sw t1, 28(sp)
	li t1, $FF0000                        ; color = 0xFF0000;
	sw t1, 32(sp)
	jal VS_FillQuad                       ; VS_FillQuad(x1,y1,x2,y2,x3,y3,x4,y4,color);
	nop 
	...
	li t1, 36                             ; y4 = 36;
	sw t1, 28(sp)
	li t1, $0000FF                        ; color = 0x0000FF;
	sw t1, 32(sp)
	jal VS_FillSemiTransQuad              ; VS_FillSemiTransQuad(x1,y1,x2,y2,x3,y3,x4,y4,color);
	nop 
	jal VS_DrawSync                       ; VS_DrawSync();
	nop 
	li a0, 70                             ; x1 = 70;
