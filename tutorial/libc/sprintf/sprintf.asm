...
DrawStrings:
	la a0, DestString                     ; dest = DestString;
	la a1, Format                         ; fmt = Format;
	la a2, String                         ; arg1 = String;
	li a3, VS_YEAR                        ; arg2 = VS_YEAR;
	jal VS_Sprintf                        ; VS_Sprintf(dest,fmt,arg1,arg2);
	nop
	li a0, 5                              ; x = 5;
	li a1, 35                             ; y = 35;
	la a2, DestString                     ; string = DestString;
...
DestString:
	.empty, 68
String:
	.ascii "PLAYSTATION RELEASE YEAR"
Format:
	.ascii "%s - %d"